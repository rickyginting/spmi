@extends('template.HomeView',['title'=>"Multi Search"])
@section('content')
        ...
        <section>
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Multi Search</h2>
                    <p>Pencarian menyeluruh hingga ke sub folder</p>
                </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="/multi-search/hasil" method="post" enctype="multipart/form-data">
                                    @csrf
