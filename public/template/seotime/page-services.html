		...
		<section class="section">
			<div class="container">
				<div class="row service-list">
					<div class="col-md-4 col-sm-12 col-xs-12 first">
						<div class="service-wrapper">	
							<img src="upload/service_01.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-01.html" title="">SEO Consultants</a></h4>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="service-wrapper">
							<img src="upload/service_02.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-02.html" title="">SEO Audits</a></h4>
					...
					<div class="col-md-4 col-sm-12 col-xs-12 last">
						<div class="service-wrapper">
							<img src="upload/service_03.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-02.html" title="">SEO Packages & Plans</a></h4>
					...
					<div class="col-md-4 col-sm-12 col-xs-12 first">
						<div class="service-wrapper">
							<img src="upload/service_04.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-04.html" title="">Web Copywriting</a></h4>
								<p>Phasellus consequat egestas tempor. Fusce lacus et ligula consequat imperdiet vel non ligula. Aliquam lorem leo, dapibus eu cras amet.</p>
								<a href="#" class="readmore">View Details</a>
							</div>
						</div><!-- end service-wrapper -->
					</div><!-- end col -->
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="service-wrapper">
							<img src="upload/service_05.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-05.html" title="">SEO Copywriting</a></h4>
								<p>Phasellus consequat egestas tempor. Fusce lacus et ligula consequat imperdiet vel non ligula. Aliquam lorem leo, dapibus eu cras amet.</p>
								<a href="#" class="readmore">View Details</a>
							</div>
						</div><!-- end service-wrapper -->
					...
					<div class="col-md-4 col-sm-12 col-xs-12 last">
						<div class="service-wrapper">
							<img src="upload/service_06.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-06.html" title="">Keyword Research</a></h4>
								<p>Pellentesque diam lorem, convallis ac auctor pretium, commodo ac lectus. Maecenas quis dui vel velit blandit ultrices vitae ut enim donec sed.</p>
								<a href="#" class="readmore">View Details</a>
							</div>
						</div><!-- end service-wrapper -->
					...
					<div class="col-md-4 col-sm-12 col-xs-12 first">
						<div class="service-wrapper">
							<img src="upload/service_07.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-07.html" title="">SEO Strategy</a></h4>
								<p>Donec non faucibus ligula. Phasellus fermentum tincidunt neque ac ultricies. Aenean felis eros, volutpat vitae lobortis vel, feugiat non metus. </p>
								<a href="#" class="readmore">View Details</a>
							</div>
						</div><!-- end service-wrapper -->
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="service-wrapper">
							<img src="upload/service_08.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-08.html" title="">Website Design</a></h4>
								<p>Phasellus consequat egestas tempor. Fusce faucibus et ligula consequat imperdiet vel non ligula. Aliquam lorem leo, dapibus eu cras amet.</p>
								<a href="#" class="readmore">View Details</a>
							</div>
						</div><!-- end service-wrapper -->
					...
					<div class="col-md-4 col-sm-12 col-xs-12 last">
						<div class="service-wrapper">
							<img src="upload/service_09.jpg" alt="" class="img-responsive">
							<div class="service-details">
								<h4><a href="service-09.html" title="">Link Building</a></h4>
								<p>Pellentesque diam lorem, convallis ac auctor pretium, commodo ac lectus. Maecenas quis dui vel velit blandit ultrices vitae ut enim donec sed.</p>
								<a href="#" class="readmore">View Details</a>
							</div>
						</div><!-- end service-wrapper -->
				...
				<div class="section-button clearfix text-center">
					<p class="lead">If you are looking a custom search engine optimization service for your company please get a quote!</p>
