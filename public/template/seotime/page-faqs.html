				    ...
				    <div class="container-fluid">
				        ...
				        <div id="navbar" class="navbar-collapse collapse">
				            <ul class="nav navbar-nav navbar-right">
				                ...
				                <li class="active"><a href="page-contact.html">Contact</a></li>
			...
			<div class="container">
				<div class="row">	
					<div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
						<h2>FAQS</h2>
						<p class="lead">To answer all of your questions, read frequently asked questions.</p>
					</div><!-- end col -->
				</div><!-- end row -->
			</div><!-- end container -->
		</section><!-- end section -->
		...
		<section class="section">
			<div class="container">
				<div class="row contactv2 text-center">
					<div class="col-md-4">
						<div class="small-box">
							...
							<h4>Visit forums</h4>
							<p><a href="#">yoursite.com/forum</a></p>
						</div><!-- end small-box -->
					</div><!-- end col -->
					...
					<div class="col-md-4">
						<div class="small-box">
							...
							<p><a href="#">yoursite.com/ticket</a></p>
						</div><!-- end small-box -->
					</div><!-- end col -->
					...
					<div class="col-md-4">
						<div class="small-box">
							...
							<h4>Call us today</h4>
							<p><a href="tel:#">+90 987 665 55 44 </a></p>
						</div><!-- end small-box -->
					</div><!-- end col -->
				</div><!-- end contactv2 -->
						...
						<div class="faqs-template">
						    <div class="panel-group" id="accordion">
						        <div class="panel panel-default">
						            <div class="panel-heading">
						                <h4 class="panel-title">
						                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">1. What is SEO? <i class="fa fa-angle-down"></i></a>
						                </h4>
						            </div>
						            <div id="collapseOne" class="panel-collapse collapse in">
						                <div class="panel-body">
						                    <p>All major search engines such as Google, Bing and Yahoo have primary search results, where web pages and other content such as videos or local listings are shown and ranked based on what the search engine considers most relevant to users. Payment isn’t involved, as it is with paid search ads.</p>
						                </div>
						            </div>
						        </div>
						        <div class="panel panel-default">
						            <div class="panel-heading">
						                <h4 class="panel-title">
						                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">2. What is SEO friendly URL? <i class="fa fa-angle-down"></i></a>
						                </h4>
						            </div>
						            <div id="collapseTwo" class="panel-collapse collapse">
						                <div class="panel-body">
						                    <p>Bootstrap is a powerful front-end framework for faster and easier web development. It is a collection of CSS and HTML conventions. <a href="#" target="_blank">Learn more.</a></p>
						                </div>
						            </div>
						        </div>
						        <div class="panel panel-default">
						            <div class="panel-heading">
						                <h4 class="panel-title">
						                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">3. How to fix CSS errors for better SEO? <i class="fa fa-angle-down"></i></a>
						                </h4>
						            </div>
						        ...
						        <div class="panel panel-default">
						            <div class="panel-heading">
						                <h4 class="panel-title">
						                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">4. Is there payment back if I am not happy? <i class="fa fa-angle-down"></i></a>
						                </h4>
						            </div>
						        ...
						        <div class="panel panel-default">
						            <div class="panel-heading">
						                <h4 class="panel-title">
						                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">5. When your package will be complete? <i class="fa fa-angle-down"></i></a>
						                </h4>
						            </div>
				...
				<div class="section-button clearfix text-center">
					<h4>Your answer not here? for all pre sale questions submit a ticket.</h4>
					<br>
					<a href="#" class="btn btn-transparent">Submit Ticket</a>
