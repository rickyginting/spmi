		...
		<section class="section bt">
			<div class="container">
				<div class="row text-center">
					<div class="col-md-12">
						<div class="media-box">
							<img src="upload/service_big_01.jpeg" alt="" class="img-responsive">
						</div><!-- end media box -->

						<div class="info-box text-center">
							<h2>SEO Consultancy Service</h2>
							<p class="lead">With our SEO service, would you like to increase the visibility of your business on Google and other search engines? We are following a simple and safe way for you. We are analyzing your site, fixing the mistakes and making your site more relevant to SEO.</p>
						</div><!-- end info-box -->
					</div><!-- end col -->
				</div><!-- end row -->
				...
				<div class="row service-list">
					<div class="col-md-4 col-sm-12 col-xs-12 first">
						<div class="service-wrapper">	
							<img src="upload/service_mini_01.jpg" alt="" class="img-responsive img-thumbnail">
							<div class="service-details">
								<h4><a href="service-01.html" title="">Optimizing Web Master Tools</a></h4>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="service-wrapper">
							<img src="upload/service_mini_02.jpg" alt="" class="img-responsive img-thumbnail">
							<div class="service-details">
								<h4><a href="service-02.html" title="">Increasing Number of Visitors</a></h4>
					...
					<div class="col-md-4 col-sm-12 col-xs-12 last">
						<div class="service-wrapper">
							<img src="upload/service_mini_03.jpg" alt="" class="img-responsive img-thumbnail">
							<div class="service-details">
								<h4><a href="service-02.html" title="">Showcasing Your Business</a></h4>
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-12">
						<div class="about-widget">
							...
							<h3>Why SEO Consultancy Service</h3>
							...
							<p>Phasellus consequat egestas tempor. Fusce faucibus et ligula consequat imperdiet vel non ligula. Aliquam Proin tempor dolor a auctor convallis. Nam accumsan commodo elitorem leo, dapibus eu cras amet.</p>
                    ...
                    <div class="col-md-5 col-sm-12">
						<div class="about-img noshadow">
							<img src="upload/seo.png" alt="" class="img-responsive">
						</div>
                    </div>
                </div><!-- end row -->
