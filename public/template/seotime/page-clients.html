			...
			<div class="container">
				<div class="row">	
					<div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
						<h2>Our Clients</h2>
						<p class="lead">You can find our solution partners in the list below</p>
					</div><!-- end col -->
				</div><!-- end row -->
			</div><!-- end container -->
		</section><!-- end section -->
		...
		<section class="section">
			<div class="container">
				<div class="row clientv2">
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="client-box">
							<a href="#"><img src="upload/client_07.png" alt="" class="img-responsive"></a>
						</div>
					</div><!-- end col -->
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="client-box">
							<a href="#"><img src="upload/client_09.png" alt="" class="img-responsive"></a>
						</div>
					</div><!-- end col -->

					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="client-box">
							<a href="#"><img src="upload/client_10.png" alt="" class="img-responsive"></a>
						</div>
					</div><!-- end col -->

					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="client-box">
							<a href="#"><img src="upload/client_11.png" alt="" class="img-responsive"></a>
						</div>
					</div><!-- end col -->

					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="client-box">
							<a href="#"><img src="upload/client_12.png" alt="" class="img-responsive"></a>
						</div>
					</div><!-- end col -->
				</div><!-- end row -->
			</div><!-- end container -->
